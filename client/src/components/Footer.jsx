    ...
    bg="rgba(30, 30, 30, 1)"
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 6 }} spacing={8}>
          <Stack color="gray" align={'flex-start'}>
            <ListHeader >ABOUT</ListHeader>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/helpcentre?otracker=${otracker}_navlinks'}>
              Contact Us
            </Box>
            <Stack direction={'row'} align={'center'} spacing={2}>
              <Box color="white" fontSize="14px" as="a" href={'https://corporate.flipkart.net/corporate-home'}>
                About us
              </Box>
            
            </Stack>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkartcareers.com/?otracker=${otracker}_navlinks'}>
              Careers
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'http://stories.flipkart.com/'}>
              Flipkart Stories
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'http://stories.flipkart.com/category/top-stories/news/'}>
              Press
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkartwholesale.com/'}>
              Flipkart Wholesale
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.cleartrip.com/'}>
              Cleartrip
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/corporate-information'}  >
          ...
          <Stack color="gray" align={'flex-start'}>
            ...
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/payments'}>
              Payments
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/shipping'}>
              Shipping
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/helpcentre?catalog=55c9c6edb000002e002c1701&view=CATALOG'}>
              Cancellation & Returns
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/helpcentre?catalog=55c9c8e2b0000023002c1702&view=CATALOG'}>
             FAQ
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://seller.flipkart.com/fiv?otracker=${otracker}_navlinks'}>
              Report Infringement
            </Box>
          </Stack>

          <Stack color="gray" align={'flex-start'}>
            <ListHeader>CONSUMER POLICY</ListHeader>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/returnpolicy?otracker=${otracker}_navlinks'}>
              Cancellation & Returns
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/terms?otracker=${otracker}_navlinks'}>
              Terms Of Use
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/paymentsecurity?otracker=${otracker}_navlinks'}>
              Security
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/privacypolicy?otracker=${otracker}_navlinks'}>
              Privacy
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/sitemap?otracker=${otracker}_navlinks'}>
              Sitemap
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/grievance-redressal-mechanism?otracker=${otracker}_navlinks'}>
              Grievance Redressal
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.flipkart.com/pages/ewaste-compliance-tnc?otracker=${otracker}_navlinks'}>
              EPR Compliance
            </Box>
          </Stack>
          <Stack color="gray" align={'flex-start'}>
            <ListHeader>SOCIAL</ListHeader>
            <Box color="white" fontSize="14px" as="a" href={'https://www.facebook.com/flipkart'}>
              Facebook
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.twitter.com/flipkart'}>
              Twitter
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'https://www.youtube.com/flipkart'}>
              You Tube
            </Box>
          ...
          <Stack color="gray" align={'flex-start'}>
            ...
            <Box color="white" fontSize="14px" as="a" href={'#'}>
            ...
            <Box color="white" fontSize="14px" as="a" href={'#'}>
              Outer ring road,Devarabeesanahali Village,
            </Box>
            <Box color="white" fontSize="14px" as="a" href={'#'}>
              Bengaluru,560103,
            </Box>
